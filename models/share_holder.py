...
class DrogaShareHolder(models.Model):
    ...
    region=fields.Many2one(related="city2.region",string="Region")
...
class examinationForm(models.Model):
    ...
    hpi = fields.Text(string= "HPI", help = "HPI(pain location, types, radiate, severity, timing,weight change,sleep disturbance)")
